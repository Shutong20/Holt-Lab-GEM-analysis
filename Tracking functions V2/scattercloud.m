...
%First run 'alpha_D_graph.m' to have its functional output variables
%Then use this function as "scattercloud(log(Total_D_inst),Total_alpha,25,1,'k.','jet')"
