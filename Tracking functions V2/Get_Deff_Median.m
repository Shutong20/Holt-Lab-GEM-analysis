function [Dmed, Dlin] = Get_Deff_Median(Complex) 
    if nargin <1 || Complex == 0
        Complex = 0
        Min_Deff = 0;
        Max_Deff = 10;
        V3 = 0;
...
legend(names,'Location','best','FontSize', 20)
xlim([0,6])
...
set(gca, 'XTick', 1:length(names),'XTickLabel',names,'FontSize', 20);
ylabel( 'Median tracklength','FontSize', 20);
set(gca,'xticklabel',names,'FontSize', 20)
set(gca,'XTickLabelRotation',45)
